...
// Import handlers (removed pluginManager import)
...
🔥 Bot is ready to serve!`;
    ...
    // Group participant updates handler
    sock.ev.on('group-participants.update', async (update) => {
      try {
        await GroupHandler(sock, [update], config);
      } catch (error) {
        console.error(chalk.red('❌ Group participant handler error:'), error.message);
      }
    });
