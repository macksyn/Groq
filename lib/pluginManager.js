...
class PluginManager {
  ...
  /**
   * Enables a plugin, updates its state in the DB, and maps its commands.
   * @param {string} filename The filename of the plugin to enable.
  ...
  /**
   * Disables a plugin, updates its state in the DB, and unmaps its commands.
   * @param {string} filename The filename of the plugin to disable.
   * @returns {Promise<{success: boolean, message: string}>}
   */
